...
class Modbus : public uart::UARTDevice, public Component {
 public:
  ...
  void send_raw_no_crc(const std::vector<uint8_t> &payload);
...
class ModbusDevice {
 public:
  ...
  virtual void on_modbus_raw_data(const std::vector<uint8_t> &raw_data) {}
  ...
  void send_raw_no_crc(const std::vector<uint8_t> &payload) { this->parent_->send_raw_no_crc(payload); }
